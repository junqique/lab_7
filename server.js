...
app.get('/player_info/post', function(req, res) {
    ...
    var query3 = `select count(*) from football_players INNER JOIN football_games on football_players.id = ANY(football_games.players) where football_players.id = ${req.query.player_choice}`;
    db.task('get-everything', task => {
      return task.batch([
          task.any(query1),
          task.any(query2),
